...
public:
	...
	*/
	...
	bool findBoard(Board b){
		if (root != nullptr){
			return findBoard(b, root);
		}
		return false;
	}
	int removed = 0;
private:
	...
	*/
	...
	AvlNode* removeMin(AvlNode* &t){
		if (t == nullptr){
			...
			if (t->right != nullptr){
				...
				temp = new AvlNode(t->element, nullptr, nullptr, 0);
				delete t;
				t = nullptr;
			}
			removed++;
			...
			if (t->left->right != nullptr){
				...
				temp = new AvlNode(t->left->element, nullptr, nullptr, 0);
				delete (t->left);
				t->left = nullptr;
				balance(t);
			}
	...
	bool findBoard(Board b, AvlNode* &t){
		if (t == nullptr){
			return false;
		}
		if (b == t->element.b){
			...
			return findBoard(b, t->left) || findBoard(b, t->right);
		}
	}
